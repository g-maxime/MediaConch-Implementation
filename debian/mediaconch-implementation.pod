...
MediaConch-Implementation - implementation checker, reporter and fixer for media files

MediaConch-Implementation-Gui - implementation checker, reporter and fixer for media files (graphical utility)

=head1 SYNOPSIS

=over

=item mediaconch-implementation [F<-Options>...] F<FileName1> [F<Filename2>...]

=item mediaconch-implementation-gui [F<-Options>...] F<FileName1> [F<Filename2>...]
...
MediaConch-Implementation is an extensible, open source software project consisting of an
implementation checker, reporter, and fixer that targets
...
=head2 Implementation Checker

=over

=item B<--Implementation=ImplementationFileName>, B<-p ImplementationFileName>

Apply the implementation (XSL or Schematron)
