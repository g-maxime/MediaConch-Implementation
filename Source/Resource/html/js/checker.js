$(document).ready(function() {
    ...
    $('#file form').on('submit', function (e) {
        e.preventDefault();
        var err = webpage.on_file_upload_selected("",
                                                  "",
                                                  "",
...
<button type="button" class="btn btn-default" data-dismiss="modal">Close</button> \
            ...
            if (WEBMACHINE === 'WEB_MACHINE_KIT') {
                data = webpage.on_fill_implementation_report(fileId, "", "");
                displayReport('#modalConformance' + resultId, data);
            } else {
                webpage.on_fill_implementation_report(fileId, "", "", function (data) {
                    displayReport('#modalConformance' + resultId, data);
                });
            }
    ...
    nodeImplem.find('.implem-dld').on('click', function(e) {
        ...
        webpage.on_save_implementation_report(fileId, "", "");
    });
}
